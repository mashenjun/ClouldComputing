    ...
    while (valid):
        ...
        if len(not_match_busy) > 0:
            ...
            for instance_id in not_match_busy:
                ...
                logger.debug("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
                thread(start_stopping_instance_idle,ec2,client,instance_id,static)
            ...
            for instance_id in not_match_idle:
                ...
                static.remove_from_idle(instance_id)
                logger.debug("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
                thread(start_stopping_instance_idle,ec2,client,instance_id,static)
        time.sleep(2)
    #return response
...
def start_stopping_instance_idle(ec2,client,reboot_id,static):
    while (1):
        time.sleep(1)
        ...
        if reboot_id in stopped_instances_ids:
            break
    EC2_handler.start_instance(client,reboot_id)
    thread(EC2_handler.wait_worker_init,ec2,static,reboot_id)
